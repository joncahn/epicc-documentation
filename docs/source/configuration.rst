...
Prepare your sample metadata file (default to ``config/all_samples.tsv``) with the required columns below (see below for more details specific to each data-type):
